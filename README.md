...
RoJoPa ist modular aufgebaut und kann grundsätzlich mit passenden Adapter-Platten auch für andere Dosen angepasst werden. Die meisten mechanischen Komponenten werden mit einem 3D-Drucker erstellt. Die entsprechenden FreeCAD- und STL-Dateien sind enthalten. Zusätzlich werden einige wenige _Lego_-Bauteile benötigt.
...
RoJoPa is modular and can basically be adapted for other drums with suitable adapter plates. Most of the mechanical components are created with a 3D printer. The corresponding FreeCAD and STL files are included. In addition, a few _Lego_ components are needed.
